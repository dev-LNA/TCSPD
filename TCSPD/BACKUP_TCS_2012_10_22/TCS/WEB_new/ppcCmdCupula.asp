...
function girar(sentido)	{
	document.subform.comando1.value = 'CUP DOMO LIGAR_LCB';
	document.subform.comando2.value = 'CUP DOMO GIRAR_' + sentido;
	document.subform.comandos.value = "2";
	document.subform.submit();
}
function velocidade(vel)	{
	document.subform.comando1.value = 'CUP DOMO LIGAR_' + vel;
...
<tr>
  <td align="center">&nbsp;
    <input type="button" value=" RAPIDO " onClick="velocidade('RAP');"></td>
  <td align="left">&nbsp;&nbsp;
    <input type="button" value=" LENTO " onClick="velocidade('JOG');"></td></tr>
